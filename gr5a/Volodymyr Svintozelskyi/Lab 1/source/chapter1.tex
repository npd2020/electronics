...
\begin{figure}[h]
	...
	\vfill
	\begin{minipage}[h]{0.47\linewidth}
		\center{\includegraphics[angle=90,width=1\linewidth]{img/F0013TEK.JPG}} Шим шум\\
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.47\linewidth}
		\center{\includegraphics[angle=90,width=1\linewidth]{img/F0014TEK.JPG}} FFT для шим шуму\\
	\end{minipage}
...
\begin{figure}[h]
	...
	\hfill
	\begin{minipage}[h]{0.47\linewidth}
		\center{\includegraphics[width=1\linewidth]{img/lis/ALL0001_.pdf}} Відповідна фігура Лісажу.\\
	\end{minipage}
	\vfill
	\begin{minipage}[h]{0.47\linewidth}
	...
	\hfill
	\begin{minipage}[h]{0.47\linewidth}
		\center{\includegraphics[width=1\linewidth]{img/lis/ALL0002_.pdf}} Відповідна фігура Лісажу\\
	\end{minipage}
	\vfill
	\begin{minipage}[h]{0.47\linewidth}
	...
	\hfill
	\begin{minipage}[h]{0.47\linewidth}
		\center{\includegraphics[width=1\linewidth]{img/lis/ALL0006_.pdf}} Відповідна фігура Лісажу \\
	\end{minipage}
...
\begin{figure}[h]
	...
	\hfill
	\begin{minipage}[h]{0.47\linewidth}
		\center{\includegraphics[width=1\linewidth]{img/lis/ALL0003_.pdf}} Відповідна фігура Лісажу \\
	\end{minipage}
	\vfill
	\begin{minipage}[h]{0.47\linewidth}
	...
	\hfill
	\begin{minipage}[h]{0.47\linewidth}
		\center{\includegraphics[width=1\linewidth]{img/lis/ALL0004_.pdf}} Відповідна фігура Лісажу \\
	\end{minipage}
	\vfill
	\begin{minipage}[h]{0.47\linewidth}
	...
	\hfill
	\begin{minipage}[h]{0.47\linewidth}
		\center{\includegraphics[width=1\linewidth]{img/lis/ALL0005_.pdf}} Відповідна фігура Лісажу \\
	\end{minipage}
	\caption{Картинки, отримані на екрані осцилографа, за допомогою невідомого генератору та DDS9850}
	\label{fig:part22}
\end{figure}
